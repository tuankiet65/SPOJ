...
procedure q_push(var q: queue; s: string; c: longint; n, rep: longint);
 begin
  inc(q[0].re);
  q[q[0].re].n:=s+chr(48+c);
  q[q[0].re].re:=(rep*10+c) mod n;
 end;
