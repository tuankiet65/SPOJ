...
function r_return(dat: r; c: longint): r;
 begin
  r_return:=dat;
...
function process(n: longint): string;
 var a: array [0..99999] of boolean;
     q: queue;
     tmp: r;
 begin
